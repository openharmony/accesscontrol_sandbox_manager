...
#include "unsetsharefileinfostub_fuzzer.h"
...
namespace {
    ...
    bool UnsetShareFileInfoStubFuzzTest(const uint8_t *data, size_t size)
    {
        ...
        uint32_t code = 0xffc5;  // COMMAND_UNSET_SHARE_FILE_INFO from IDL
...
{
    OHOS::UnsetShareFileInfoStubFuzzTest(data, size);
    return 0;
}
