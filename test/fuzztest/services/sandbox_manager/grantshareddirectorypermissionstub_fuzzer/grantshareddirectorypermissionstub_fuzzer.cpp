...
#include "grantshareddirectorypermissionstub_fuzzer.h"
...
namespace OHOS {
    ...
    bool GrantSharedDirectoryPermissionStubFuzzTest(const uint8_t *data, size_t size)
    {
        ...
        uint32_t code = 0xffc7;  // COMMAND_GRANT_SHARED_DIRECTORY_PERMISSION from IDL
...
{
    OHOS::GrantSharedDirectoryPermissionStubFuzzTest(data, size);
    return 0;
}
