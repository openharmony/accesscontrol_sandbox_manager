...
#include "cleanpolicybyuserid_fuzzer.h"
...
static uint32_t FILE_MANAGER_TOKEN = 0;
    ...
    bool CleanPolicyByUserIdFuzzTest(const uint8_t *data, size_t size)
    {
        ...
        SandboxManagerKit::CleanPolicyByUserId(userId, pathList);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::CleanPolicyByUserIdFuzzTest(data, size);
    return 0;
}