 ...
 * @tc.desc: SetShareFileInfo with normal input.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(SandboxManagerKitPermissionTest, SetShareFileInfoTest001, TestSize.Level0)
{
    int32_t uid = getuid();
 ...
 * @tc.require:
 */
HWTEST_F(SandboxManagerKitPermissionTest, SetShareFileInfoTest002, TestSize.Level0)
{
    int32_t uid = getuid();
    setuid(FOUNDATION_UID);
    std::string cfginfo = R"({
 ...
 * @tc.desc: UpdateShareFileInfo with normal input.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(SandboxManagerKitPermissionTest, UpdateShareFileInfoTest001, TestSize.Level0)
{
    int32_t uid = getuid();
    setuid(FOUNDATION_UID);
    std::string cfginfo = R"({
 ...
 * @tc.require:
 */
HWTEST_F(SandboxManagerKitPermissionTest, UpdateShareFileInfoTest002, TestSize.Level0)
{
    int32_t uid = getuid();
    setuid(FOUNDATION_UID);
    std::string cfginfo = R"({
 ...
 * @tc.require:
 */
HWTEST_F(SandboxManagerKitPermissionTest, UnsetShareFileInfoTest001, TestSize.Level0)
{
    int32_t uid = getuid();
    setuid(FOUNDATION_UID);
    std::string bundleName = "com.example.test";
 ...
 * @tc.require:
 */
HWTEST_F(SandboxManagerKitPermissionTest, UnsetShareFileInfoTest002, TestSize.Level0)
{
    int32_t uid = getuid();
    setuid(FOUNDATION_UID);
    std::string bundleName = "com.example.test";
 ...
 * @tc.desc: GetSharedDirectoryInfo with normal input.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(SandboxManagerKitPermissionTest, GetSharedDirectoryInfoTest001, TestSize.Level0)
{
