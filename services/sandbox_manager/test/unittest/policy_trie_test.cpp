...
HWTEST_F(PolicyTrieTest, PolicyTrieTestDeniedPathsBlockInherit, TestSize.Level0)
{
    ...
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/appdata/sub", MODE_RW), false);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/Appdata/sub", MODE_RW), false);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/appdata/any/file.txt", MODE_RW), false);

    // other denied paths should also be blocked
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/.Trash", MODE_RW), false);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/.trash", MODE_RW), false);

    // normal sub-paths should still match
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/docs", MODE_RW), true);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/docs/file.txt", MODE_RW), true);
...
HWTEST_F(PolicyTrieTest, PolicyTrieTestAuthorizeAppdataCaseInsensitive, TestSize.Level0)
{
    ...
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/appdata/sub", MODE_RW), true);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/Appdata/sub", MODE_RW), true);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/APPDATA/sub", MODE_RW), true);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/appdata/any/file.txt", MODE_RW), true);

    // other denied paths should still be blocked
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/.Trash", MODE_RW), false);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/.thumbs", MODE_RW), false);
...
HWTEST_F(PolicyTrieTest, PolicyTrieTestCurrentUserCaseSensitive, TestSize.Level0)
{
    ...
    EXPECT_EQ(trie.CheckPath("/storage/Users/CURRENTUSER", MODE_RW), false);
    EXPECT_EQ(trie.CheckPath("/storage/Users/CURRENTUSER/file.txt", MODE_RW), false);
    EXPECT_EQ(trie.CheckPath("/storage/Users/CurrentUser", MODE_RW), false);
    EXPECT_EQ(trie.CheckPath("/storage/Users/CurrentUser/file.txt", MODE_RW), false);

    // correct case matches
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser", MODE_RW), true);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/file.txt", MODE_RW), true);
...
HWTEST_F(PolicyTrieTest, PolicyTrieTestDeniedDeepPath, TestSize.Level0)
{
    ...
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/appdata", MODE_RW), true);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/appdata/el2", MODE_RW), true);
    EXPECT_EQ(trie.CheckPath("/storage/Users/currentUser/appdata/other/file.txt", MODE_RW), true);

    // deep denied .thumbs path and its sub-paths should still be blocked
    EXPECT_EQ(trie.CheckPath(
